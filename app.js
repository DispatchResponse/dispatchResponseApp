...
var trackUserStation = require('./routes/track_user_station')
var stationApparatus = require('./routes/station_apparatus')
...
app.use('/api/track_user_station', trackUserStation)
app.use('/api/station_apparatus', stationApparatus)
